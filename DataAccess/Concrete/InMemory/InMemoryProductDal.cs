   ...
   public class InMemoryProductDal : IProductDal
    {
        ...
        public InMemoryProductDal()
        {
            ...
            {
                new Product {ProductId =1, CategoryId =1, ProductName ="Bardak",UnitPrice = 500, UnitsInStock = 15 },
                new Product {ProductId =2, CategoryId =2, ProductName ="Kamera",UnitPrice = 500, UnitsInStock = 3 },
                new Product {ProductId =3, CategoryId =2, ProductName ="Telefon",UnitPrice = 1500, UnitsInStock = 2 },
                new Product {ProductId =4, CategoryId =2, ProductName ="Klavye",UnitPrice = 150, UnitsInStock = 65 },
                new Product {ProductId =5, CategoryId =32, ProductName ="Fare",UnitPrice = 85, UnitsInStock = 1 }
        ...
        {
            //LINQ Language Inteegrated Query
            //direk verdiğimiz veriyi silemiyoruz. 
